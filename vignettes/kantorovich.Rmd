...
The `kantorovich` package provides two other functions to compute the Kantorovich distance:
...
Then `kantorovich_lp` does not return the better decimal approximation of $13/63$:
